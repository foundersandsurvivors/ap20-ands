<?php
    /**
     * Basic serialisation example -- adapted by sms to use BIO
     *
    ...
    EasyRdf_Namespace::set('fas', 'http://convix.org/fas/1.0/');
    EasyRdf_Namespace::set('bio', 'http://purl.org/vocab/bio/0.1/');

    $graph = new EasyRdf_Graph();
    $me = $graph->resource('http://convix.org/fas#me', 'foaf:Person');
    ...
    $me->set('foaf:dateOfDeath', new EasyRdf_Literal_Date('1999-10-13'));
    $me->set('fas:dateOfTransportation', new EasyRdf_Literal_Date('1990-10-13'));
    $me->set('foaf:height', 1.82);
    $me->set('bio:mother', 'Mary Bloggs');
    $me->set('bio:father', 'Jim Bloggs');
